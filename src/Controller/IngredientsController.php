...
class IngredientsController extends AbstractController
{
    ...
    public function index(EntityManagerInterface $entityManager, IngredientsRepository $ingredientsRepository): Response
    {
        
        $ingredients = $entityManager->getRepository(Ingredients::class)->findAll();
    ...
    public function new(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            $unIngredient = new Ingredients();
            $unIngredient->setNomM($form->get("nomM")->getData());
